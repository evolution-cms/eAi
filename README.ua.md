...
### sTask UI воркери
Коли sTask встановлено, eAi автоматично реєструє два видимі воркери:
- `eai_smoke` — фіксований prompt (швидкий smoke‑тест).
- `eai_prompt` — кастомний prompt з віджета.

Вони з’являються в інтерфейсі sTask і дозволяють перевірити AI end‑to‑end.
